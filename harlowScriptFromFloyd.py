...
def run(length, width, height, fps, level, record, demo, demofiles, video):
  ...
  # initialize the directories' names to save the models for this particular see
  model_path = dir_name+'/model_' + str(0)
  frame_path = dir_name+'/frames_' + str(0)
  plot_path = dir_name+'/plots_' + str(0)
  load_model_path = "meta_rl/results/biorxiv/final/model_" + str(0) + "/model-20000"
