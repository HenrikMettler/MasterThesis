...
def main(args=None):
    ...
    n_threads = 32
    gamma = 0.99
    lr = 0.0007  #Todo: check in Wang 2017
    ...
    args = Create_Args(nb_episodes, batch_size, consecutive_frames, training_interval, n_threads, gamma, lr, gather_stats, render, env)
    ...
    action_dim = 2  #gym.make(args.env).action_space.n

    # create A3C instance
    algo = A3C(action_dim, env_dim, args.consecutive_frames, lstm_param_list, args.gamma, args.lr)
