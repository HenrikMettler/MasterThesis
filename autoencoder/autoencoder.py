...
loss ='mse' # default from keras documentation
batch_size = 256
num_epochs = 50
...
for idx_set in range(1):
    ...
    # Train Model
    autoencoderModel.compile(optimizer=optimizer, loss=loss)
    current_trainhistory = autoencoderModel.fit(x_train, x_train, epochs=num_epochs, batch_size=batch_size, shuffle=True, verbose=0, validation_data=(x_test,x_test))
    train_history.append(current_trainhistory)
